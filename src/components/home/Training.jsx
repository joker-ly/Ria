                ...
                <Row>
                    ...
                    <Card
                      ...
                      <Card
                        className="max-w-sm"
                        imgAlt="Apple Watch Series 7 in colors pink, silver, and black"
                        imgSrc={require("../../assets/images/22.jpg")}
                      >
                        <a href="#">
                          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                      ...
                      <Card
                        className="max-w-sm"
                        imgAlt="Apple Watch Series 7 in colors pink, silver, and black"
                        imgSrc={require("../../assets/images/J39A4281-scaled.jpg")}
                      >
                        <a href="#">
                          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                      ...
                      <Card
                        className="max-w-sm"
                        imgAlt="Apple Watch Series 7 in colors pink, silver, and black"
                        imgSrc={require("../../assets/images/J39A4162-scaled.jpg")}
                      >
                        <a href="#">
                          <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
